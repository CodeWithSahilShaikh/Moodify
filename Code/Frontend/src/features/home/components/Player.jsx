...
const Player = () => {
    ...
    return (
        <div className="player">
            <audio
                ref={audioRef}
                src={hasSong ? song.url : undefined}
            ...
            <div className="player__info">
                <img
                    ...
                    src={hasSong ? song.posterUrl : ''}
                    alt={hasSong ? song.title : 'No song selected'}
                />
                <div className="player__meta">
                    <p className="player__title">{hasSong ? song.title : 'No song selected'}</p>
                    <span className="player__mood">{hasSong ? song.mood : 'Choose a mood to start'}</span>
                </div>
            </div>
